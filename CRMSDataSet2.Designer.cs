...
namespace CRMS.CRMSDataSet2TableAdapters {
...
SELECT Customerid, Customername, Customerdocuments, Customeraddress, Customernumber, Customergender, Customerage, Customerlicense FROM Customer WHERE (Customerid = @Customerid)";
        ...
        public virtual int Fill(CRMSDataSet2.CustomerDataTable dataTable) {
        ...
        public virtual CRMSDataSet2.CustomerDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            CRMSDataSet2.CustomerDataTable dataTable = new CRMSDataSet2.CustomerDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(CRMSDataSet2.CustomerDataTable dataTable) {
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(CRMSDataSet2 dataSet) {
        ...
        public virtual int Delete(int Original_Customerid, string Original_Customername, string Original_Customeraddress, global::System.Nullable<long> Original_Customernumber, string Original_Customergender, global::System.Nullable<int> Original_Customerage) {
        ...
        public virtual int Insert(int Customerid, string Customername, string Customerdocuments, string Customeraddress, global::System.Nullable<long> Customernumber, string Customergender, global::System.Nullable<int> Customerage, string Customerlicense) {
            ...
            if ((Customerage.HasValue == true)) {
                this.Adapter.InsertCommand.Parameters[6].Value = ((int)(Customerage.Value));
            }
            else {
        ...
        public virtual int Update(int Customerid, string Customername, string Customerdocuments, string Customeraddress, global::System.Nullable<long> Customernumber, string Customergender, global::System.Nullable<int> Customerage, string Customerlicense, int Original_Customerid, string Original_Customername, string Original_Customeraddress, global::System.Nullable<long> Original_Customernumber, string Original_Customergender, global::System.Nullable<int> Original_Customerage) {
            ...
            if ((Customerage.HasValue == true)) {
                this.Adapter.UpdateCommand.Parameters[6].Value = ((int)(Customerage.Value));
            }
            else {
            ...
            if ((Original_Customerage.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[18].Value = ((int)(Original_Customerage.Value));
            }
            else {
